...
const Header = () => {
  ...
  return (
    ...
    >
      <motion.div
        className='text-stone-500 inline-flex text-center gap-2 bg-whote px-6 py-1 rounded-full border border-neutrel-500'
      ...
      <motion.p className='text-center max-w-xl max-auto mt-5'
        ...
        animate={{ opacity: 1, y: 0 }}
      >Unleash your creativity with AI. Turn your imagination into visual art in seconds - just type, and wath the magic happen.</motion.p>
      <motion.button
        className='sm:text-lg text-white bg-black w-auto mt-8 px-10 py-2.5 flex items-center gap-2 rounded-full'
